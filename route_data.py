...
GCI_CURRENT_SCORE = 88
GCI_STATUS_LABEL = "Extreme — contested closure, disputed partial flow"
GCI_LAST_UPDATED = date(2026, 6, 21)
GCI_SOURCE_NOTE = (
    "Verified via live search on June 21, 2026 (crisis Day 112). The strait "
    "remains effectively closed to mainstream commercial shipping (live "
    "trackers show near-zero AIS-broadcasting commercial transits vs ~94/day "
    "pre-crisis baseline). However, the picture is now contested: Iran's "
    "military command has re-declared the strait closed citing MoU violations, "
    "while the US reports some vessels transiting. Independent maritime "
    "intelligence (Windward) observed roughly 32 transits on June 20, skewed "
    "toward Chinese and Indian state operators, with significant 'dark' "
    "(AIS-off) traffic making exact counts uncertain. Score eased from 92 to "
    "88 to reflect a disputed partial flow rather than absolute zero, though "
    "conditions remain extreme. Update weekly from public crisis reporting."
)
...
GCI_HISTORY = [
    ...
    {"date": date(2026, 6, 21), "score": 88, "label": "Contested closure, disputed partial flow"},
]
